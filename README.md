...
- SwiftMac is free to use (no subscription and no paywall) and open source under the MIT license.
- Production-ready for notarized direct download; App Store sandbox migration is in progress.
